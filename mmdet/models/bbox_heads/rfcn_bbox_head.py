...
class RfcnBBoxHead(nn.Module):
    ...
    def __init__(self,
        ...
        super(RfcnBBoxHead, self).__init__()
        ...
        self.cls_pool = nn.AvgPool2d((7, 7), stride=(7, 7))
        self.loc_pool = nn.AvgPool2d((7, 7), stride=(7, 7))
